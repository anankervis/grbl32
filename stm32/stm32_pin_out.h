...
#if AXIS_COUNT == 3
# define DIR_MASK        (DIR_X_Pin | DIR_Y_Pin | DIR_Z_Pin)
# define STEP_MASK       (STEP_X_Pin | STEP_Y_Pin | STEP_Z_Pin)
#elif AXIS_COUNT == 4
# define DIR_MASK        (DIR_X_Pin | DIR_Y_Pin | DIR_Z_Pin | DIR_A_Pin)
# define STEP_MASK       (STEP_X_Pin | STEP_Y_Pin | STEP_Z_Pin | STEP_A_Pin)
#elif AXIS_COUNT == 5
# define DIR_MASK        (DIR_X_Pin | DIR_Y_Pin | DIR_Z_Pin | DIR_A_Pin | DIR_B_Pin)
# define STEP_MASK       (STEP_X_Pin | STEP_Y_Pin | STEP_Z_Pin | STEP_A_Pin | STEP_B_Pin)
#elif AXIS_COUNT == 6
# define DIR_MASK        (DIR_X_Pin | DIR_Y_Pin | DIR_Z_Pin | DIR_A_Pin | DIR_B_Pin | DIR_C_Pin)
# define STEP_MASK       (STEP_X_Pin | STEP_Y_Pin | STEP_Z_Pin | STEP_A_Pin | STEP_B_Pin | STEP_C_Pin)
#else
# error unsupported axis count
#endif
